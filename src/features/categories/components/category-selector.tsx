...
export function CategorySelector({ value, onChange, disabled }: CategorySelectorProps) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger 
        className={cn(
          "flex w-full items-center justify-between h-8 text-xs bg-muted/50 hover:bg-muted px-3 rounded-md border border-input outline-none focus:ring-1 focus:ring-ring",
